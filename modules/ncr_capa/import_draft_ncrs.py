...
Imports draft_ncrs.csv into the NCR/CAPA database.
...
DEFAULT_DRAFT_NCR_PATH = DATA_DIR / "draft_ncrs.csv"
...
def main():
    ...
    if not csv_path.exists():
        ...
        print("Options:")
        print("1. Generate/import draft_ncrs.csv into the shared data folder")
        print("2. Supply a custom file path")
        print("   python import_draft_ncrs.py /path/to/draft_ncrs.csv")
